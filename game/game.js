(function () {
  ...
  async function init() {
    try {
      const [core, phaseFlow, mapZoom, aiHeuristics, aiPhaseSearch, aiTactics, scenario, rules, aiWeights] = await Promise.all([
        coreRulesPromise,
        phaseFlowPromise,
        mapZoomPromise,
        aiHeuristicsPromise,
      ...
      wireUi();
      applyMapZoom(app.mapZoomLevel, { preserveCenter: false, persist: false });
      loadImages();
      applyLanguage();
      updateMenu();
      draw();
